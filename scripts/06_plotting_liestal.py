...
from flow_depth_plotting import g_plots_selected_wd_liestal_dinamic

# ─── Parameters ──────────────────────────────────────────────────────────────

dem_file = "/storage/homefs/ge24z347/LISFLOOD_FP_8_1/build/Liestal_2m/Liestal_2m.dem"
geo_shapefile = "/storage/homefs/ge24z347/LISFLOOD_FP_8_1/Data_forprocess/geo_ezgg_2km_ge.shp"
...
# ─── Loop over LISFLOOD ensemble outputs ─────────────────────────────────────
...
for i in range(1, 12):
    ...
    g_plots_selected_wd_liestal_dinamic(
        dem_file=dem_file,
        wd_folder=wd_folder,
...
print("✅ All ensemble plots completed.")