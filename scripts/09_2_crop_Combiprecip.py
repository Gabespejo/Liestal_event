...
def main():
    ...
    p.add_argument("--orig-nc", required=True, help="Input NetCDF")
    ...
    p.add_argument("--rain-factor", type=float, default=1.0,
                   help="Multiplicative factor applied to rainfall depth (e.g. 0.8, 1.1)")
